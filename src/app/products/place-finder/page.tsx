      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">
                {searchMode === 'smart' ? 'AIスマート検索のサンプル' : '通常検索のサンプル'}（ワンクリックで入力）
              </label>
        ...
        {aiAnalysis && (
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200 p-6 mb-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-blue-900">AI検索分析</h3>
            </div>
            
            <div className="space-y-4">
              <div>
                <h4 className="text-sm font-medium text-blue-800 mb-2">最適化された検索クエリ:</h4>
                <p className="text-blue-700 bg-white rounded-lg px-4 py-2 border border-blue-200">
                  {aiAnalysis.optimizedQuery}
                </p>
              </div>
              
              <div>
                <h4 className="text-sm font-medium text-blue-800 mb-2">AI分析:</h4>
              ...
              <div>
                <h4 className="text-sm font-medium text-blue-800 mb-2">検索のコツ:</h4>
                <p className="text-blue-600 text-sm bg-white rounded-lg px-4 py-2 border border-blue-200">
