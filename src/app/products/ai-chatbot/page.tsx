            ...
            <div className="border-t border-gray-200 p-4">
              <div className="flex space-x-2">
                <input
                  ...
                  className="flex-1 border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black placeholder-gray-400"
                  disabled={isLoading}
                />
                <button
